...
";
            ...
            string path_change_reg = @"E:\all\document\ProgectVisualStudio\C#\test\createVHD\createVHD\run_script_change_ps.bat";
            ...
            if (!Directory.Exists(path))
            {
                ...
                {                   
                    ...
                    Process pp = new Process();    //  Change value in the regedit          
                    pp.StartInfo.FileName = path_change_reg;
